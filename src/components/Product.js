...
import { productCartInfo, productInfo } from '../data';
...
export default function Product({ isProduct, onChangeSetProduct }) {
  ...
  const handleChangeOnClick = () => {
    ...
    for (let i = 0; i < cartArray.length; i++) {
      const spliced = productCartInfo.splice(i, 0, productCartInfo);
      cartArray.push(...spliced);
    }
    onChangeSetProduct(cartArray);
  }
